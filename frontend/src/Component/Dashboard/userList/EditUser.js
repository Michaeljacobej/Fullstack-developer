...
function EditUser() {
 ...
 const[user,setUser]=React.useState('')
  ...
  // var id = window.location.href.substring(window.location.href.id.lastIndexOf('/') + 1);
  ...
  const handleClick=(e)=>{
      ...
      fetch(`http://localhost:8080/data/custommer/${id}`,{
        method:"PUT",
        headers:{"Content-Type":"application/json"},
        body:JSON.stringify(custommerAccount)
      }).then(()=>{
        console.log("Update Custommer Account is Done")
        // console.log(id)
